      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-64 space-y-6">
            ...
            {/* Navigation */}
            <nav className="bg-surface rounded-xl border border-surface/50 p-2">
            ...
            {/* Danger Zone */}
            <div className="bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-200 dark:border-red-800/30 p-2">
              <p className="text-xs font-medium text-red-600 dark:text-red-400 px-3 py-1">
                Danger Zone
              </p>
              <ul className="space-y-1">
